...
def main_worker(
    ...
    print("\nFreezing all but last 4 layers of the network")
    ct = 0
    ...
    # Setting AUTO_RESUME to True
    if True and os.path.exists(checkpoint_file):
    ...
    # Manually setting a limit of 100 epochs
